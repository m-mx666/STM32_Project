...
//	hspi1.Instance->CR1 |= (uint16_t)0x0020;
////	__HAL_SPI_DISABLE(&hspi1);

////	MODIFY_REG(hspi1.Instance->CR1, SPI_CR1_BR, SPI_BAUDRATEPRESCALER_32);
...
//	hspi1.Instance->CR1 &= 0XFFC7;
//	hspi1.Instance->CR1 |= (uint16_t)0x0008;
