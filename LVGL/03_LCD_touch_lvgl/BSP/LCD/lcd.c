...
/******************************************************************************
      ...
      返回值：  无
******************************************************************************/
void LCD_color_Fill(u16 xsta, u16 ysta, u16 xend, u16 yend, const lv_color_t *color_p)
{
    u32 size = (xend - xsta + 1) * (yend - ysta + 1);
...
//				buf[i + 1] = temp;
//		}
//		HAL_SPI_Transmit(&hspi1, buf, size * 2, 100);
//    while(size--) {
//        LCD_WR_DATA(color_p->full);
//        color_p++;
//    }
		
		HAL_SPI_Transmit(&hspi1, (u8*)color_p, size * 2, 100);
